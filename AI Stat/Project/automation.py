...
class Tester():
    ...
    def _load_data(self): self.data = pd.read_csv(self.path_to_data); self.columns = list(self.data.columns); self._fix_data(); self._categorize_y_column(); self._add_data(); self._normalize_x_columns()
